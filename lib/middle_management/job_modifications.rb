    ...
    module ActiveRecord
      class Job < ::ActiveRecord::Base
        def self.new_with_micromanagement
          ...
          MiddleManagement::Manager.enforce_number_of_current_jobs(self.count)
        end
        class << self
        ...
        def destroy_with_micromanagement
          ...
          MiddleManagement::Manager.enforce_number_of_current_jobs(Delayed::Backend::ActiveRecord::Job.count)
        end
